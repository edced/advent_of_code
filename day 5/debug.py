...
amount, source, target = [int(entry) for entry in lines[10].strip().split(' ') if entry.isdigit()]
class CrateStack:
...
solve(r'C:\Users\cedri\OneDrive\Documents\advent of code\day 5\input.in', part_2=True, print_crates=True)